package training2.binarysearchtree.depthfirstsearch;
...
public class DepthFirstSearch {
    ...
    public static boolean solution(Node tree, int targetValue) {
        ...
        while (!stack.isEmpty()) {
            ...
            if (curNode.getValue() == targetValue) return true;
            if (curNode.getRight() != null) stack.push(curNode.getRight());
            if (curNode.getLeft() != null) stack.push(curNode.getLeft());
